...
function jgtstork_scripts_styles() {
	...
	wp_enqueue_style( 'jgtstork-ie', get_template_directory_uri() . '/css/ie.css', array( 'jgtstork-style' ), '1.6.0' );
	...
	// Add custom scripts.
	wp_enqueue_script( 'jgtstork-script', get_template_directory_uri() . '/js/custom.js', array( 'jquery' ), '1.6.0', true );
}
